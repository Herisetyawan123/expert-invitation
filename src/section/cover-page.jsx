...
function CoverPage() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] px-10 fixed bg-[#423740] bg-[url('/wallpaper.png')] bg-no-repeat bg-center bg-cover flex justify-center items-center">
      <div className="rounded-md relative">
        <div className="absolute w-full h-full flex flex-col justify-center items-center">
          <h3 className="font-semibold text-3xl font-['Playfair+Display'] text-[#d7c1a0] mb-10">
            Wedding Invitation
          </h3>
          <div className="cover-text text-center text-4xl mt-10 font-['Tangerine'] text-[#d7c1a0] font-bold">
            <h1>Anhar Muchlis</h1>
            <p>&</p>
            <h1>Deana</h1>
          </div>
          ...
          {/* date */}
          <p className="font-['Playfair+Display'] my-10 text-[#d7c1a0]">
            10 January 2024
          </p>
          <button
